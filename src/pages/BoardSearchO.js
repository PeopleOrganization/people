...
function Board() {
  ...
  useEffect(() => {
    axios
      .post("http://people-env.eba-35362bbh.ap-northeast-2.elasticbeanstalk.com:3001/searchO", null, {
        params: {
        ...
        <ui className="sidebarCircle">
          <ul className="sidebarList">
            ...
            <a className="href" href="BoardO">
              {" "}
              <li className="sidebarListItem active">O혈액형</li>
            </a>
            &nbsp;
          </ul>
        </ui>
